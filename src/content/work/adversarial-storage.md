...
summary: Designed and led production of a ciphertext-only decentralized storage network built around ongoing interactive proof of spacetime, with Pedersen commitments, seed-chained challenges, and a sliding-window incentive model.
role: Protocol design lead, production operations
status: selective
order: 3
tags: [protocol, decentralized, cryptography, incentives]
year: "2022"
featured: true
---
